...
// 1. Remova o trecho que definia formRegistrar.action e formRegistrar.method
...
configurarFormulario({
    ...
    aoEnviar: async (form) => {
        // 2. Se a sua função 'configurarFormulario' já não fizer isso internamente, 
        // garanta que o formulário não recarregue a página de forma nativa.
